...
class DirectFBPaintEnginePrivate;

class DirectFBPaintEngine : public QRasterPaintEngine
{
    Q_DECLARE_PRIVATE(DirectFBPaintEngine)
public:
    DirectFBPaintEngine(QPaintDevice *device);
    virtual ~DirectFBPaintEngine();
