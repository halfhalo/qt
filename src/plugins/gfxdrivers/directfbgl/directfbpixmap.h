...
#ifndef DIRECTFBPIXMAP_H
#define DIRECTFBPIXMAP_H
...
class DirectFBPixmapData : public QPixmapData, public DirectFBPaintDevice
{
public:
    DirectFBPixmapData(DirectFBGLScreen *screen, PixelType pixelType);
    ~DirectFBPixmapData();
    ...
    virtual int metric(QPaintDevice::PaintDeviceMetric m) const { return DirectFBPaintDevice::metric(m); }
