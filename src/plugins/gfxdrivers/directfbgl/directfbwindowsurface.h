...
#ifndef DIRECFBWINDOWSURFACE_H
#define DIRECFBWINDOWSURFACE_H
...
class DirectFBWindowSurface : public QWSWindowSurface, public DirectFBPaintDevice
{
public:
    DirectFBWindowSurface(DFBSurfaceFlipFlags flipFlags, DirectFBGLScreen *scr);
    DirectFBWindowSurface(DFBSurfaceFlipFlags flipFlags, DirectFBGLScreen *scr, QWidget *widget);
    ~DirectFBWindowSurface();
